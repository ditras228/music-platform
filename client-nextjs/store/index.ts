...
import {Context, createWrapper, GetServerSidePropsContext} from 'next-redux-wrapper'
...
export const makeStore = (context: Context) => createStore(reducer, bindMiddleware([thunk]));
